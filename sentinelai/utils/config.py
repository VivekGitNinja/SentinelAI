...
Description: Configuration utilities for SentinelAI framework
"""
...
class SentinelConfig:
    """Configuration manager for SentinelAI framework."""
    
    DEFAULT_CONFIG_PATHS = [
        os.path.expanduser("~/.sentinelai.config.ini"),
        os.path.join(os.getcwd(), "sentinelai.ini"),
    ]
...
def get_config(config_path: Optional[str] = None) -> SentinelConfig:
    """
    ...
    if _config is None or config_path:
        _config = SentinelConfig(config_path)
