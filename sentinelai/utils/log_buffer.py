...
def get_log_buffer(capacity: Optional[int] = None) -> LogRingBuffer:
    """Return the process-wide SentinelAI log ring buffer."""
...
def uninstall_buffer_handler(logger: Optional[logging.Logger] = None, logger_name: str = "sentinelai.) -> None:
...
def clear_log_buffer() -> None:
    """Clear the process-wide SentinelAI log buffer."""
