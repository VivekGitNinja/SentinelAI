"""
SentinelAI SDK Policy System

Provides policy-based action configuration for SentinelAI rule matches.
"""
...
class SentinelPolicy:
    """
    Policy configuration for mapping SentinelAI rules to actions.
