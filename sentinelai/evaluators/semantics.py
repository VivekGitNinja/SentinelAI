...
from sentinelai.evaluators.base import SemanticEvaluator
from sentinelai.utils.logger import get_logger

# Get logger for this module
logger = get_logger("sentinelai.evaluators.semantics")
    ...
    def _load_model(self) -> bool:
        ...
        with _MODEL_CACHE_LOCK:
            ...
            try:
                ...
                # Configure transformers to avoid FutureWarning (moved here from sentinelai.__init__.py
