...
Description: Condition evaluator for SentinelAI rules with improved error handling
"""
...
logger = get_logger("sentinelai.evaluators.condition")
...
def check_prompt_safe(prompt, matcher_obj):
    ...
    Args:
        ...
        matcher_obj: The matcher object (SentinelMatcher instance)
